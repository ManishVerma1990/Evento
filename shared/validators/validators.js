...
const EventSchema = z.object({
  organizerId: z.string(), //references some userId
  title: z.string(),
...
const RegSchema = z.object({
  eventId: z.uuidv4(), //references some event
  userId: z.uuidv4(), //refereces the user that is registering
  regType: z.string(),
  checkIn: z.boolean(),
...
//   })
// );
export { UserSchema, EventSchema, RegSchema };
